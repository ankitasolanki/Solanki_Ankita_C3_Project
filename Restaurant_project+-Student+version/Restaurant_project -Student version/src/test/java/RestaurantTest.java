...
class RestaurantTest {
    ...
    public void is_restaurant_open_should_return_true_if_time_is_between_opening_and_closing_time(){
        ...
        LocalTime dummyLocalTime = LocalTime.parse("20:00:00");
        Mockito.when(restaurant.getCurrentTime()).thenReturn(dummyLocalTime);
    ...
    public void is_restaurant_open_should_return_false_if_time_is_outside_opening_and_closing_time(){
        ...
        Restaurant mockRestaurant = Mockito.mock(Restaurant.class);
        LocalTime dummyLocalTime = LocalTime.parse("23:00:00");
        Mockito.when(restaurant.getCurrentTime()).thenReturn(dummyLocalTime);
